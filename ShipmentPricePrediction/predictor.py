...
from ShipmentPricePrediction.entity.config_entity import MODEL_FILE_NAME,TRANSFORMER_OBJECT_FILE
...
class ModelResolver:
    def __init__(self, model_registry: str = "saved_models", transformer_dir_name="transformer",
                 model_dir_name="model", target_encoder_dir_name="target_encoder"):
